...
def precreate():
    ...
    with openapi_client.ApiClient() as api_client:
        ...
        block_list = (
            '["d05f84cf5340d1ef0c5f6d6eb8ce13b8"]'  # str | 由MD5字符串组成的list
        )
...
def upload():
    ...
    with openapi_client.ApiClient() as api_client:
        ...
        uploadid = (
            "N1-MTA2LjEzLjc2LjI0MDoxNjU0NTAwMDE0OjE3NDEzNzMyMTUxNTY1MTA2MQ=="  # str |
        )
        type = "tmpfile"  # str |
        try:
            file = open(
                "./uploadtestdata/a.txt", "rb"
            )  # file_type | 要进行传送的本地文件分片
